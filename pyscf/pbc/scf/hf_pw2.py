...
class RHF_PW(hf.RHF):
    ...
    def get_fock_no_pypseudo(self, j, vg, h1e, cell=None, kpt=None):
        ...
        for aa in range(0,len(GH_ind)):
            ...
            #loc = get_loc_pp_vec(Gd2[inds],v,-7.33610297,0,0,0,0.44,4)+get_nonloc_pp_vec(sphg,pg,aa)[aa:]
            #hcore[aa,aa:]=loc*sf[inds]+vg[inds]
            #fock[aa,aa:]=h1e[inds]+vg[inds]
            fock[aa,aa:]=vg[inds]
